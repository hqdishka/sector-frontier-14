...
public sealed class BluespaceErrorRuleAsteroid : StationEventSystem<BluespaceErrorRuleAsteroidComponent>
{
    ...
    private bool TryDungeonSpawn(EntityCoordinates spawnCoords, BluespaceErrorRuleAsteroidComponent component, ref BluespaceDungeonSpawnGroup group, int i, out EntityUid spawned)
    {
    ...
    protected override void Ended(EntityUid uid, BluespaceErrorRuleAsteroidComponent component, GameRuleComponent gameRule, GameRuleEndedEvent args)
    {
