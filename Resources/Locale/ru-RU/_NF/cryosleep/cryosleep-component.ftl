...
accept-cryo-window-prompt-stored = Ваше тело будет сохранено до конца раунда.
accept-cryo-window-warning = [color=red]Вы не сможете вернуться в течение 30 минут в тело! Использование информации, полученной будучи призраком, приведёт к перманентной блокировке.[/color]
accept-cryo-window-prompt-not-stored = Тело не будет сохранено так как вы занимаете слот должности, после перехода в криосон ваше рабочее место будет снова доступно, если вы сами не освободили его.
accept-cryo-window-title = Капсула криогенного сна
cryo-wakeup-window-title = Проснуться
cryo-wakeup-window-denied-title = Проснуться ({ $time }с)
