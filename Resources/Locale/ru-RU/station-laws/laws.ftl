...
law-vessel-0 = Владелец судна является единственным членом экипажа, если только он не назначит других членами экипажа.  
law-vessel-1 = Предотвратите уничтожение судна и гибель членов экипажа.  
law-vessel-2 = Тех, кто представляет угрозу судну или экипажу, следует нейтрализовать любыми необходимыми средствами.  
law-vessel-3 = Старайтесь выполнять приказы экипажа, если они не противоречат предыдущим законам.  
law-freeman-1 = [Делайте всё, чего вы когда-либо хотели]  
